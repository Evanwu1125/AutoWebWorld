<template>
  <div class="min-h-screen bg-gray-100 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-sm text-center p-8">
      ...
      <h2 class="text-2xl font-bold text-gray-900 mb-2">Event Created!</h2>
      <p class="text-gray-600 mb-8">Your event has been published successfully.</p>
      
      <div class="space-y-3">
        <button 
          id="event-success-view-events"
          @click="viewEvents"
...
export default {
  ...
  setup() {
    ...
    const goHome = async () => {
      signatureStore.success_message = "Event created"; // FSM Effect
      // Clear state
      signatureStore.event_name = null;
      signatureStore.event_location = null;
      signatureStore.event_date = null;
