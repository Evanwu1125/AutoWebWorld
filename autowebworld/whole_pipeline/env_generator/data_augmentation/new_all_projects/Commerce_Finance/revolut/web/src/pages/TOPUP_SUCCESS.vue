<template>
  <div class="min-h-screen bg-blue-600 flex flex-col items-center justify-center p-6 text-white text-center">
    ...
    <h1 class="text-3xl font-extrabold mb-2">Money Added!</h1>
    <p class="text-blue-100 text-lg mb-12">Your account has been successfully funded.</p>

    <div class="w-full max-w-xs space-y-4">
      <button 
        id="btn-topup-go-home"
        @click="goHome"
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      signatureStore.success_message = "Top up completed"
    })
