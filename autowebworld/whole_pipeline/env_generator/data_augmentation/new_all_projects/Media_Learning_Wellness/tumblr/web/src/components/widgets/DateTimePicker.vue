<template>
  <div class="dtp">
    ...
    <!--
    ╔══════════════════════════════════════════════════════════════════════════════╗
    ║ ⚠️ 重要：必须使用 v-show，禁止改为 v-if！                                      ║
    ║ IMPORTANT: Must use v-show, DO NOT change to v-if!                           ║
    ║                                                                              ║
    ║ 原因：v-if 会在 open=false 时从 DOM 中移除 .ym-vertical 元素                  ║
    ║ Playwright 测试需要元素始终存在于 DOM 中（即使不可见）                          ║
    ╚══════════════════════════════════════════════════════════════════════════════╝
    -->
    <div v-show="open" class="dtp-popover" ref="popover" tabindex="0" @keydown.enter.prevent="open=false">
      <div class="dtp-left">
