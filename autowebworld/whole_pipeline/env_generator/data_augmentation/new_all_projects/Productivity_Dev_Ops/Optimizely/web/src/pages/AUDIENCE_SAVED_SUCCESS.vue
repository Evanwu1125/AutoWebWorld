  ...
  <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 text-center">
        ...
        <h2 class="text-2xl font-bold text-gray-900 mb-2">Audience Saved!</h2>
        <p class="text-gray-600 mb-8">Your audience definition has been saved successfully.</p>
        
        <div class="space-y-4">
          <button 
            id="btn-view-audiences"
            @click="goToAudiences"
...
export default {
  ...
  setup() {
    ...
    // FSM Effect
    signatureStore.success_message = "Audience saved successfully"
