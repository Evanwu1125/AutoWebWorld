...
export const useDataStore = defineStore('data', () => {
  ...
  const repositories = ref([
    { id: "repo_1", name: "sample-repo", description: "A sample repository for testing", private: false, stars: 1200, updated_at: "2023-10-01", language: "JavaScript", owner_id: "user_1", image: "/images/repositories_repo_1.jpg" },
    { id: "repo_2", name: "linux", description: "Linux kernel source tree", private: false, stars: 150000, updated_at: "2023-11-15", language: "C", owner_id: "user_3", image: "/images/repositories_repo_2.jpg" },
    { id: "repo_3", name: "git", description: "Git source code", private: false, stars: 45000, updated_at: "2023-11-10", language: "C", owner_id: "user_1", image: "/images/repositories_repo_3.jpg" },
    { id: "repo_4", name: "vue", description: "Vue.js Core", private: false, stars: 200000, updated_at: "2023-11-18", language: "TypeScript", owner_id: "user_6", image: "/images/repositories_repo_4.jpg" },
    { id: "repo_5", name: "react", description: "A declarative, efficient, and flexible JavaScript library for building user interfaces.", private: false, stars: 210000, updated_at: "2023-11-19", language: "JavaScript", owner_id: "user_1", image: "/images/repositories_repo_5.jpg" },
    { id: "repo_6", name: "vscode", description: "Visual Studio Code", private: false, stars: 140000, updated_at: "2023-11-20", language: "TypeScript", owner_id: "user_1", image: "/images/repositories_repo_6.jpg" },
    { id: "repo_7", name: "bootstrap", description: "The most popular HTML, CSS, and JS library in the world.", private: false, stars: 160000, updated_at: "2023-10-25", language: "CSS", owner_id: "user_5", image: "/images/repositories_repo_7.jpg" },
    { id: "repo_8", name: "tensorflow", description: "Computation using data flow graphs for scalable machine learning", private: false, stars: 170000, updated_at: "2023-11-12", language: "C++", owner_id: "user_1", image: "/images/repositories_repo_8.jpg" },
    { id: "repo_9", name: "private-project", description: "Top secret project", private: true, stars: 5, updated_at: "2023-11-21", language: "Python", owner_id: "user_1", image: "/images/repositories_repo_9.jpg" },
    { id: "repo_10", name: "node", description: "Node.js JavaScript runtime", private: false, stars: 98000, updated_at: "2023-11-14", language: "JavaScript", owner_id: "user_1", image: "/images/repositories_repo_10.jpg" },
    { id: "repo_11", name: "electron", description: "Build cross-platform desktop apps with JavaScript, HTML, and CSS", private: false, stars: 105000, updated_at: "2023-11-01", language: "C++", owner_id: "user_1", image: "/images/repositories_repo_11.jpg" },
    { id: "repo_12", name: "angular", description: "One framework. Mobile & desktop.", private: false, stars: 85000, updated_at: "2023-10-30", language: "TypeScript", owner_id: "user_1", image: "/images/repositories_repo_12.jpg" },
    { id: "repo_13", name: "flutter", description: "Flutter makes it easy and fast to build beautiful apps for mobile and beyond", private: false, stars: 155000, updated_at: "2023-11-22", language: "Dart", owner_id: "user_1", image: "/images/repositories_repo_13.jpg" },
    { id: "repo_14", name: "d3", description: "Bring data to life with SVG, Canvas and HTML.", private: false, stars: 100000, updated_at: "2023-09-15", language: "JavaScript", owner_id: "user_5", image: "/images/repositories_repo_14.jpg" },
    { id: "repo_15", name: "django", description: "The Web framework for perfectionists with deadlines.", private: false, stars: 70000, updated_at: "2023-11-05", language: "Python", owner_id: "user_1", image: "/images/repositories_repo_15.jpg" },
    { id: "repo_16", name: "rails", description: "Ruby on Rails", private: false, stars: 53000, updated_at: "2023-10-20", language: "Ruby", owner_id: "user_4", image: "/images/repositories_repo_16.jpg" },
    { id: "repo_17", name: "laravel", description: "A PHP framework for web artisans", private: false, stars: 73000, updated_at: "2023-11-11", language: "PHP", owner_id: "user_1", image: "/images/repositories_repo_17.jpg" },
    { id: "repo_18", name: "webpack", description: "A bundler for javascript and friends.", private: false, stars: 63000, updated_at: "2023-08-10", language: "JavaScript", owner_id: "user_1", image: "/images/repositories_repo_18.jpg" },
    { id: "repo_19", name: "kubernetes", description: "Production-Grade Container Scheduling and Management", private: false, stars: 102000, updated_at: "2023-11-17", language: "Go", owner_id: "user_1", image: "/images/repositories_repo_19.jpg" },
    { id: "repo_20", name: "ansible", description: "Ansible is a radically simple IT automation platform", private: false, stars: 58000, updated_at: "2023-10-12", language: "Python", owner_id: "user_1", image: "/images/repositories_repo_20.jpg" }
  ]);
