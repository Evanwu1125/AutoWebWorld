...
from ..actions.base import Action, ActionHandler, ActionResult, ActionSpec
from .types import ActionType, BackendType, parse_action_type, parse_backend


class ActionEngine:
    """Entry point: parse raw actions, route to handlers, and execute."""

    def __init__(self) -> None:
        self._specs: Dict[ActionType, ActionSpec] = {}
        self._handlers: Dict[Tuple[BackendType, ActionType], ActionHandler] = {}
